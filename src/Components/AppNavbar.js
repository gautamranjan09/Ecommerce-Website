      ...
      <Container >
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto ">
            <Nav.Link as={NavLink} className="mx-4" to="/main/home" activeStyle={{ textDecoration: 'underline', color: '#ffb300' }}>
              Home
            </Nav.Link>
            <Nav.Link as={NavLink} className="mx-4" to="/main/store" activeStyle={{ textDecoration: 'underline', color: '#ffb300' }}>
              Store
            </Nav.Link>
            <Nav.Link as={NavLink} className="mx-4" to="/main/about" activeStyle={{ textDecoration: 'underline', color: '#ffb300' }}>
              About
            </Nav.Link>
            <Nav.Link as={NavLink} className="mx-4" to="/main/contact" activeStyle={{ textDecoration: 'underline', color: '#ffb300' }}>
              Contact Us
            </Nav.Link>
            {isLoggedIn && (
              <Nav.Link as={NavLink} className="mx-4" to="/main/profile" activeStyle={{ textDecoration: 'underline', color: '#ffb300' }}>
                Profile
              </Nav.Link>
            )}
          </Nav>
